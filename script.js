...
const s2_sfx = new Audio('./css/s2 (2).mp3')
...
let scoreboardTable;
if (sessionStorage.getItem('scoreboard')) {
  scoreboardTable = JSON.parse(sessionStorage.getItem('scoreboard'));
} else {
  scoreboardTable = [];
}
let finalScore;
...
function enterName(e) {
  if (e.keyCode === 13) {
    ...
    sessionStorage.setItem('scoreboard', JSON.stringify(scoreboardTable));
